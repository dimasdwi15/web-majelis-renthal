...
>
    ...
    <div class="bg-geo">
        <svg width="700" height="700" viewBox="0 0 440 440" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="220" cy="220" r="200"
                stroke="rgba(101,94,68,0.12)" stroke-width="1"
                stroke-dasharray="6 10"/>
            @for($i = 0; $i < 24; $i++)
            <line
                x1="{{ 220 + 192 * cos(deg2rad($i * 15)) }}"
                y1="{{ 220 + 192 * sin(deg2rad($i * 15)) }}"
                x2="{{ 220 + 202 * cos(deg2rad($i * 15)) }}"
                y2="{{ 220 + 202 * sin(deg2rad($i * 15)) }}"
                stroke="rgba(101,94,68,0.2)" stroke-width="1.2"/>
            @endfor

            <circle cx="220" cy="220" r="152"
                stroke="rgba(101,94,68,0.1)" stroke-width="1"
                stroke-dasharray="3 8"/>
            @for($i = 0; $i < 8; $i++)
            <rect
                x="{{ 220 + 152 * cos(deg2rad($i * 45)) - 3 }}"
                y="{{ 220 + 152 * sin(deg2rad($i * 45)) - 3 }}"
                width="6" height="6"
            ...
            <line x1="20"  y1="220" x2="420" y2="220" stroke="rgba(101,94,68,0.06)" stroke-width="1"/>
            <line x1="220" y1="20"  x2="220" y2="420" stroke="rgba(101,94,68,0.06)" stroke-width="1"/>
            <line x1="78"  y1="78"  x2="362" y2="362" stroke="rgba(101,94,68,0.04)" stroke-width="1"/>
            <line x1="362" y1="78"  x2="78"  y2="362" stroke="rgba(101,94,68,0.04)" stroke-width="1"/>
            ...
            @php
                ...
                $hex2 .= 'Z';
            @endphp
            <path d="{{ $hex2 }}" stroke="rgba(101,94,68,0.22)" stroke-width="1" fill="rgba(101,94,68,0.04)"/>
    ...
    <div class="top-nav">
        <div class="brand-logo">
            ...
            <div>
                <p style="color:#4a4530;font-size:12px;font-weight:800;letter-spacing:0.14em;margin:0;line-height:1.15;">MAJELIS</p>
                <p style="color:rgba(101,94,68,0.5);font-size:9px;font-weight:600;letter-spacing:0.22em;margin:0;line-height:1.2;">RENTAL SYSTEM</p>
            </div>
        </div>
    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <div class="card-header">
                ...
                <div style="position:relative;z-index:2;display:flex;align-items:center;gap:8px;margin-bottom:16px;">
                    <div style="width:7px;height:7px;border-radius:50%;background:rgba(242,232,198,0.25);flex-shrink:0;"></div>
                    <p style="color:rgba(242,232,198,0.35);font-size:9px;font-weight:700;letter-spacing:0.22em;margin:0;text-transform:uppercase;">
            ...
            <div class="forms-grid">
                ...
                <div
                    ...
                    style="padding:26px 26px 30px 26px;"
                >
                    <div style="margin-bottom:22px;">
                        <h2 style="font-size:21px;font-weight:900;color:#251D1D;letter-spacing:-0.03em;margin:0 0 5px 0;">
                            Selamat Datang
                        </h2>
                        ...
                        <div style="margin-bottom:16px;">
                            ...
                            <div class="inp-wrap">
                                ...
                                <button type="button" class="eye-btn" @click="showLP = !showLP" tabindex="-1">
                                    <svg x-show="!showLP" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div style="display:flex;align-items:center;gap:12px;margin:20px 0 16px;">
                        ...
                        <span style="font-size:10px;color:rgba(37,29,29,0.3);font-weight:700;letter-spacing:0.1em;white-space:nowrap;">ATAU</span>
                        <div class="sep-line"></div>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px;">
                            ...
                            <div>
                                ...
                                <input id="r_alamat" type="text" name="alamat"
                                    value="{{ old('alamat') }}"
                            ...
                            <div>
                                ...
                                <div class="inp-wrap">
                                    <input id="r_password"
                                        ...
                                        placeholder="••••••••" class="inp">
                                    <button type="button" class="eye-btn" @click="showRP = !showRP" tabindex="-1">
                                        <svg x-show="!showRP" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
                                        </svg>
                                        <svg x-show="showRP" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/>
                            ...
                            <div>
                                ...
                                <div class="inp-wrap">
                                    <input id="r_password_confirmation"
                                        ...
                                        required autocomplete="new-password"
                                        placeholder="••••••••" class="inp">
                                    <button type="button" class="eye-btn" @click="showRC = !showRC" tabindex="-1">
                                        <svg x-show="!showRC" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
                                        </svg>
                                        <svg x-show="showRC" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94"/>
                                ...
                                @error('password_confirmation')<span class="err-msg">{{ $message }}</span>@enderror
                            </div>
                        </div>
